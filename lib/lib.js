...
recommend = function (currentUser, profileUser) {
  ...
  if (currentUser.profile && profileUser.profile) {
  ...
  var locationRatio = (locationPoints/locationTotal * locationWeight) || 0

  var jobTypeRatio = (jobTypePoints/jobTypeTotal * jobTypeWeight) || 0
